...
(24, 'Itinerario de Pueblos Mágicos', 'itinerario-pueblos-magicos', 2, 'A elección', 'Rutas entre pueblos pequeños. Rutas de carretera, hospedajes boutique, experiencias culturales. Ejemplos: Real de Catorce, Cuatro Ciénegas, Xilitla. Precio con IVA incluido.', '{"codigo": "TRG-IT05", "requiere_destino": false}', '["https://images.pexels.com/photos/30746579/pexels-photo-30746579.jpeg"]'),
(25, 'Itinerario Gastronómico', 'itinerario-gastronomico', 2, 'A elección', 'Exploración de comida regional. Recomendación de 5-10 restaurantes locales, mercados tradicionales, tours gastronómicos y comida típica del destino. El cliente confirma su destino. Precio con IVA incluido.', '{"codigo": "TRG-IT04", "requiere_destino": false}', '["https://images.pexels.com/photos/17294750/pexels-photo-17294750.jpeg"]'),
(26, 'Itinerario para Road Trip', 'itinerario-road-trip', 2, 'A elección', 'Viajes en carretera. Rutas panorámicas, paradas recomendadas, gasolineras, hospedajes en carretera. Precio con IVA incluido.', '{"codigo": "TRG-IT08", "requiere_destino": false}', '["https://images.pexels.com/photos/258112/pexels-photo-258112.jpeg"]'),
(27, 'Tour Gastronómico', 'tour-gastronomico-oaxaca', 6, 'Oaxaca', 'Recorrido por mercados y zonas gastronómicas, degustación de 4 a 6 platillos típicos, explicación cultural, bebidas tradicionales, guía gastronómico, visita a cocinas tradicionales. Duración: 4 horas. Precio por persona con IVA incluido.', '{"codigo": "TRG-TL02", "requiere_destino": false}', '["https://images.pexels.com/photos/1234535/pexels-photo-1234535.jpeg"]'),
...
(29, 'Circuito de Spa y Relajación', 'circuito-spa-playa-del-carmen', 1, 'Playa del Carmen', 'Sauna y vapor, piscinas de hidroterapia, mini masaje o exfoliación, bebidas y descanso. Duración: 3-6 horas. Precio por persona con IVA incluido.', '{"codigo": "TRG-EB02", "requiere_destino": false}', '["https://images.pexels.com/photos/3321416/pexels-photo-3321416.jpeg"]'),
(30, 'Experiencia de Spa Natural con Temazcal', 'spa-natural-temazcal-bacalar', 1, 'Bacalar', 'Temazcal, masaje relajante, uso de laguna o piscina natural, bebidas naturales. Precio por persona con IVA incluido.', '{"codigo": "TRG-EB08", "requiere_destino": false}', '["https://images.pexels.com/photos/6663573/pexels-photo-6663573.jpeg"]'),
(31, 'Itinerario Familiar', 'itinerario-familiar', 2, 'A elección', 'Viajes con niños. Parques, actividades educativas y restaurantes familiares. Precio con IVA incluido.', '{"codigo": "TRG-IT10", "requiere_destino": false}', '["https://images.pexels.com/photos/1682497/pexels-photo-1682497.jpeg"]'),
(32, 'Itinerario de Aventura', 'itinerario-aventura', 3, 'A elección', 'Naturaleza y deportes extremos. Trekking, cascadas, cuevas, rafting o rappel. Destinos: Huasteca Potosina, Sierra Tarahumara, Selva Lacandona. Precio con IVA incluido.', '{"codigo": "TRG-IT06", "requiere_destino": false}', '["https://images.pexels.com/photos/931018/pexels-photo-931018.jpeg"]'),
(33, 'Paquete Explorador', 'paquete-explorador', 7, 'Nacional', 'Itinerario personalizado, recomendaciones locales, mapa interactivo. Precio con IVA incluido.', '{"codigo": "TRG-PQ01", "requiere_destino": false}', '["https://images.pexels.com/photos/672358/pexels-photo-672358.jpeg"]'),
(34, 'Experiencia de Temazcal en Resort', 'temazcal-resort-riviera-maya', 1, 'Riviera Maya', 'Ceremonia guiada por chamán, ritual con copal, bebidas herbales, acceso a instalaciones del spa. Precio por persona con IVA incluido.', '{"codigo": "TRG-EB06", "requiere_destino": false}', '["https://images.pexels.com/photos/3757942/pexels-photo-3757942.jpeg"]'),
(35, 'Itinerario Romántico', 'itinerario-romantico', 2, 'A elección', 'Parejas o luna de miel. Hoteles boutique, restaurantes románticos, experiencias privadas. Destinos: San Miguel de Allende, Valle de Bravo, Bacalar. Precio con IVA incluido.', '{"codigo": "TRG-IT09", "requiere_destino": false}', '["https://images.pexels.com/photos/1024960/pexels-photo-1024960.jpeg"]'),
(36, 'Plan Travel Planner Profesional', 'travel-planner-profesional', 5, 'Nacional', 'Itinerario detallado, mapas interactivos, asesoría por videollamada, recomendaciones personalizadas. Precio con IVA incluido.', '{"codigo": "TRG-PP01", "requiere_destino": false}', '["https://images.pexels.com/photos/4065133/pexels-photo-4065133.jpeg"]'),
(37, 'Plan Concierge de Viaje', 'concierge-de-viaje', 5, 'Nacional', 'Planificación completa, reservas de hoteles (puede llevar costo adicional), reservas de tours (puede llevar costo adicional), asistencia durante el viaje. Precio con IVA incluido.', '{"codigo": "TRG-PP02", "requiere_destino": false}', '["https://images.pexels.com/photos/3184292/pexels-photo-3184292.jpeg"]'),
(38, 'Paquete Aventura Total', 'paquete-aventura-total', 7, 'Nacional', 'Itinerario, reservas de tours (puede llevar costo adicional), guía local. Precio con IVA incluido.', '{"codigo": "TRG-PQ02", "requiere_destino": false}', '["https://images.pexels.com/photos/1371360/pexels-photo-1371360.jpeg"]'),
(39, 'Retiro Corto de Yoga y Meditación', 'retiro-yoga-malinalco', 1, 'Malinalco', 'Clases diarias de yoga, meditación guiada, alimentación saludable, actividades de bienestar. Precio por persona con IVA incluido.', '{"codigo": "TRG-EB05", "requiere_destino": false}', '["https://images.pexels.com/photos/1051838/pexels-photo-1051838.jpeg"]'),
