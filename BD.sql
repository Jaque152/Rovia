...
-- 1. LIMPIEZA 
-- =====================================================================================
-- Limpieza preventiva por si ya existían
...
-- =====================================================================================
-- 2. CREACIÓN DE NUEVAS TABLAS TRIPNOVA (Estructura Simplificada)
-- =====================================================================================
...
CREATE TABLE public.activities_tripnova (
  ...
  location VARCHAR,
  images JSONB,
  important_info JSONB, -- Solo guardaremos {"codigo": "TRG...", "requiere_destino": boolean}
...
-- =====================================================================================
-- 3. INSERTAR CATEGORÍAS TRIPNOVA
-- =====================================================================================
INSERT INTO public.categories_tripnova (id, name, slug) VALUES 
(1, 'Bienestar & Spa', 'bienestar'),
(2, 'Itinerarios a la Medida', 'itinerarios'),
(3, 'Cultura & Comunidad', 'cultura'),
(4, 'Talleres Artesanales', 'talleres'),
(5, 'Servicios de Viaje', 'servicios'),
(6, 'Gastronomía', 'gastronomia'),
(7, 'Naturaleza & Cenotes', 'naturaleza'),
(8, 'Aventura', 'aventura'),
(9, 'Paquetes Premium', 'paquetes');
SELECT setval('categories_tripnova_id_seq', 9);

-- =====================================================================================
-- 4. INSERTAR LOS 41 NUEVOS PLANES (Simplificados y con Imágenes)
-- =====================================================================================
...
(20, 'Tour de 2 Cenotes', 'tour-2-cenotes-yucatan', 7, 'Yucatán', 'Transporte local, entrada a 2 cenotes naturales, tiempo libre para nadar, chaleco salvavidas, guía local, agua o bebida hidratante, seguro básico. Duración: 4-6 horas. Precio por persona con IVA incluido.', '{"codigo": "TRG-TL01", "requiere_destino": false}', '["https://images.pexels.com/photos/2704257/pexels-photo-2704257.jpeg"]'),
...
(24, 'Itinerario de Pueblos Mágicos', 'itinerario-pueblos-magicos', 2, 'A elección', 'Rutas entre pueblos pequeños. Rutas de carretera, hospedajes boutique, experiencias culturales. Ejemplos: Real de Catorce, Cuatro Ciénegas, Xilitla. Precio con IVA incluido.', '{"codigo": "TRG-IT05", "requiere_destino": true}', '["https://images.pexels.com/photos/346885/pexels-photo-346885.jpeg"]'),
(25, 'Itinerario Gastronómico', 'itinerario-gastronomico', 2, 'A elección', 'Exploración de comida regional. Recomendación de 5-10 restaurantes locales, mercados tradicionales, tours gastronómicos y comida típica del destino. El cliente confirma su destino. Precio con IVA incluido.', '{"codigo": "TRG-IT04", "requiere_destino": true}', '["https://images.pexels.com/photos/2081199/pexels-photo-2081199.jpeg"]'),
(26, 'Itinerario para Road Trip', 'itinerario-road-trip', 2, 'A elección', 'Viajes en carretera. Rutas panorámicas, paradas recomendadas, gasolineras, hospedajes en carretera. Precio con IVA incluido.', '{"codigo": "TRG-IT08", "requiere_destino": true}', '["https://images.pexels.com/photos/346885/pexels-photo-346885.jpeg"]'),
...
(28, 'Itinerario Cultural e Histórico', 'itinerario-cultural-historico', 2, 'A elección', 'Museos, zonas arqueológicas y sitios históricos. Guías culturales, rutas históricas, museos y sitios arqueológicos. Ejemplos: Teotihuacan, Monte Alban, Palenque. Precio con IVA incluido.', '{"codigo": "TRG-IT07", "requiere_destino": true}', '["https://images.pexels.com/photos/327394/pexels-photo-327394.jpeg"]'),
...
(31, 'Itinerario Familiar', 'itinerario-familiar', 2, 'A elección', 'Viajes con niños. Parques, actividades educativas y restaurantes familiares. Precio con IVA incluido.', '{"codigo": "TRG-IT10", "requiere_destino": true}', '["https://images.pexels.com/photos/346885/pexels-photo-346885.jpeg"]'),
(32, 'Itinerario de Aventura', 'itinerario-aventura', 8, 'A elección', 'Naturaleza y deportes extremos. Trekking, cascadas, cuevas, rafting o rappel. Destinos: Huasteca Potosina, Sierra Tarahumara, Selva Lacandona. Precio con IVA incluido.', '{"codigo": "TRG-IT06", "requiere_destino": true}', '["https://images.pexels.com/photos/346885/pexels-photo-346885.jpeg"]'),
(33, 'Paquete Explorador', 'paquete-explorador', 9, 'Nacional', 'Itinerario personalizado, recomendaciones locales, mapa interactivo. Precio con IVA incluido.', '{"codigo": "TRG-PQ01", "requiere_destino": false}', '["https://images.pexels.com/photos/327394/pexels-photo-327394.jpeg"]'),
...
(35, 'Itinerario Romántico', 'itinerario-romantico', 2, 'A elección', 'Parejas o luna de miel. Hoteles boutique, restaurantes románticos, experiencias privadas. Destinos: San Miguel de Allende, Valle de Bravo, Bacalar. Precio con IVA incluido.', '{"codigo": "TRG-IT09", "requiere_destino": true}', '["https://images.pexels.com/photos/346885/pexels-photo-346885.jpeg"]'),
...
(38, 'Paquete Aventura Total', 'paquete-aventura-total', 9, 'Nacional', 'Itinerario, reservas de tours (puede llevar costo adicional), guía local. Precio con IVA incluido.', '{"codigo": "TRG-PQ02", "requiere_destino": false}', '["https://images.pexels.com/photos/327394/pexels-photo-327394.jpeg"]'),
...
(40, 'Paquete Viaje Completo', 'paquete-viaje-completo', 9, 'Nacional', 'Planificación total, reservas (puede llevar costo adicional), soporte durante el viaje. Precio con IVA incluido.', '{"codigo": "TRG-PQ03", "requiere_destino": false}', '["https://images.pexels.com/photos/327394/pexels-photo-327394.jpeg"]'),
...
-- Agregar las columnas faltantes a la tabla de reservas
ALTER TABLE public.bookings_tripnova
...
UPDATE public.categories_tripnova SET name = 'Experiencias de Bienestar', slug = 'experiencias-bienestar' WHERE id = 1;
UPDATE public.categories_tripnova SET name = 'Itinerarios de Viaje', slug = 'itinerarios-viaje' WHERE id = 2;
UPDATE public.categories_tripnova SET name = 'Tours Locales', slug = 'tours-locales' WHERE id = 3;
UPDATE public.categories_tripnova SET name = 'Talleres Artesanales', slug = 'talleres-artesanales' WHERE id = 4;
UPDATE public.categories_tripnova SET name = 'Servicios Adicionales', slug = 'servicios-adicionales' WHERE id = 5;
UPDATE public.categories_tripnova SET name = 'Paquetes Combinados', slug = 'paquetes-combinados' WHERE id = 6;
UPDATE public.categories_tripnova SET name = 'Planes Premium Travel Concierge', slug = 'premium-travel-concierge' WHERE id = 9;

-- 1. Reasignar las actividades de las categorías viejas a "Tours Locales" (ID 3)
UPDATE public.activities_tripnova 
SET category_id = 3 
WHERE category_id IN (7, 8);

-- 2. Eliminar las categorías sobrantes ("Naturaleza & Cenotes" y "Aventura")
DELETE FROM public.categories_tripnova 
WHERE id IN (7, 8);
-- Agregar también el campo de tiempo a los items (por si se ocupa más adelante)
ALTER TABLE public.booking_items_tripnova
ADD COLUMN scheduled_time VARCHAR;