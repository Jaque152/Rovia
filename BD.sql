...
CREATE POLICY "Inserción cotizaciones" ON public.custom_quotes_tripnova FOR INSERT WITH CHECK (true);
...
(9, 'Planes Premium Travel Concierge', 'premium-travel-concierge');
...
(32, 'Itinerario de Aventura', 'itinerario-aventura', 3, 'A elección', 'Naturaleza y deportes extremos. Trekking, cascadas, cuevas, rafting o rappel. Destinos: Huasteca Potosina, Sierra Tarahumara, Selva Lacandona. Precio con IVA incluido.', '{"codigo": "TRG-IT06", "requiere_destino": true}', '["https://images.pexels.com/photos/346885/pexels-photo-346885.jpeg"]'),
